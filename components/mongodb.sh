...
Print "Extracting & Loading Mongo Schema to MongoDB" "cd /tmp && unzip -o mongodb.zip && mongo < catalogue.js && mongo < users.js"
cd /tmp && unzip -o mongodb.zip && mongo < catalogue.js && mongo < users.jscd /tmp && unzip -o mongodb.zip && mongo < catalogue.js && mongo < users.js
Stat $?